...
<div className='flex flex-col gap-4'>
  <div className='flex items-center gap-2'>
    ...
    <span className='max-h-max'>15 de Abril del 2023</span>
  </div>
  ...
  <div className='flex items-center gap-4'>
    <a title='Web de este proyecto' href='https://human-to-js.juancman.dev/' target='_blank'>
      <WebIcon size='2rem' />
    </a>
    <a title='Código Fuente de este proyecto' href='https://github.com/juancmandev/human-to-js' target='_blank'>
