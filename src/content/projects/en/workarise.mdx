...
import { DateIcon, PersonIcon, WebIcon } from '@/assets/Icons';

# Workarise

![Workarise Banner](/projects/workarise-banner.png)
_Workarise Banner_

<div className='flex flex-col gap-4'>
  <div className='flex items-center gap-2'>
    <DateIcon size='1.5rem' />
    <span className='max-h-max'>April 14, 2023</span>
  </div>
  ...
  <div className='flex items-center gap-4'>
    <a title='Web of this project' href='https://workarise.com/' target='_blank'>
      <WebIcon size='2rem' />
    </a>
  </div>
</div>
