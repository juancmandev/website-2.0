...
<div className='flex flex-col gap-4'>
  <div className='flex items-center gap-2'>
    ...
    <span className='max-h-max'>April 15, 2023</span>
  </div>
  ...
  <div className='flex items-center gap-4'>
    <a title='Web of this project' href='https://human-to-js.juancman.dev/' target='_blank'>
      <WebIcon size='2rem' />
    </a>
    <a title='Source Code of this project' href='https://github.com/juancmandev/human-to-js' target='_blank'>
