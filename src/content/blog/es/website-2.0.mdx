...
subtitle: 'Cometí algunos errores al crear la primera versión de mi website, aquí compartiré lo que he aprendido.'
tags: 'Next.js, TypeScript, TailwindCSS, Vercel'
featuredImage: '/blog/website-2.0/website-2.0-header.png'
featuredImageCaption: 'Tech Stack usado para este website. Next.js, Vercel, React.js, TypeScript y TailwindCSS'
...
_Tech Stack usado para este website. Next.js, Vercel, React.js, TypeScript y TailwindCSS_

<div className='flex flex-col gap-2'>
  <div className='flex items-end gap-2'>
    <DateIcon size='1.5rem' />
    <span>7 de Abril del 2023</span>
  </div>
