...
description: 'I commited some errors when creating the first version of my website, here Ill share what Ive learned.'
tags:
  - Tech
...
![Tech stack](/blog/website-2.0/banner.png)
_Tech Stack of this website. Next.js, Vercel, React.js, TypeScript and TailwindCSS_

The first version of my website was one of my biggest projects so fat, but **now**
as I’ve **more** **experience** as a **Frontend** Engineer, I realize I **didn’t**
do **enough** **research** into **creating** a **web** site with a **blog**.
