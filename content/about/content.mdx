...
I'm trying to expand my skills, as I'm a web developer (focused on frontend),
but skills like writing are important.
...
only exception is [QuillBot](https://quillbot.com/grammar-check) for validating
my grammar.
