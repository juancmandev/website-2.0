...
In this tutorial, we'll develop a fullstack web app with the following tech stack:
...
Wait until the dependencies installation is completed, then access to the project folder:
